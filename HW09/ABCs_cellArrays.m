...
A = {[true false false], 'Georgia Tech', 23, {[1 1 2 3 5 8]}}; %you have to put the vector of numbers into its own cell because it will concatenate the 23 otherwise
...
C = {ca1{2} ca1{4}}; % (I think???) parenthesises gives back a cell and brackets give back the value
...
D(3) = []; %so the parenthesis DO give the cell arrays back???
