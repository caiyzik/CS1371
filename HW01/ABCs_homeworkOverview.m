...
%    following the questions to either 'true' or 'false' (replacing the NaN values). 
%    Note that these words are reserve words in MATLAB and must be written exactly as
%    shown.
